    ...
    <table dir="@if (Config::get('app.locale') == 'ar' || $general_setting->is_rtl) {{ 'rtl' }} @endif"
            ...
            <tr>
                ...
                <td style="border:1px solid #222;padding:1px 3px;text-align:center">
                    <x-amount-currency-symbol
                        :amount="$product_sale_data->net_unit_price"
        ...
        <tr>
            ...
            <td class="td-text"
                ...
                <x-amount-currency-symbol
                            :amount="$lims_sale_data->total_price - ($lims_sale_data->total_tax + $lims_sale_data->order_tax)"
                            :currency_symbol="$lims_sale_data->currency->symbol" />
            </td>
        </tr>
        @if ($general_setting->invoice_format == 'gst' && $general_setting->state == 1)
            <tr>
                ...
                <td class="td-text"
                    style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                    <x-amount-currency-symbol
                            :amount="$lims_sale_data->total_tax + $lims_sale_data->order_tax"
                            :currency_symbol="$lims_sale_data->currency->symbol" />
                </td>
            </tr>
        ...
        <tr>
            ...
            <td class="td-text"
                style="border:1px solid #222;padding:1px 3px;background-color:rgb(205, 218, 235);text-align: center;font-size: 15px;">
                <x-amount-currency-symbol
                        :amount="$lims_sale_data->total_discount + $lims_sale_data->order_discount"
                        :currency_symbol="$lims_sale_data->currency->symbol" />
            </td>
        </tr>
        <tr>
